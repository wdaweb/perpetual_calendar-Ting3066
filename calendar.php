...
<body class="p-5 alert-info">
  ...
  <div class="container" style="text-align:center">
    <a href="calendar.php?target=<?php echo date("Y-m",strtotime('-1 month',strtotime($target))); ?>">
    ...
    <span class="font-weight-bold text-secondary m-5 p-5" style="font-size:2rem"><?php echo date("Y-m",strtotime($target)); ?></span>
    <a href="calendar.php?target=<?php echo date("Y-m",strtotime('+1 month',strtotime($target))); ?>">
